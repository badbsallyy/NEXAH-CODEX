...
## 🕍 Resonance Cathedral – Main Visual Sequence

*The living light architecture of the Codex.*

![Resonance Cathedral – Proof Layer](./visuals/Resonance_Cathedral_Structural_Proof_Layer.png)
**Prime-based light architecture (layer system) / Primzahlbasierte Lichtarchitektur (Schichtsystem)**
The foundational proof visualizing harmonic depth, density, and axial symmetry.

![Resonance Cathedral – Proof Network](./visuals/Resonance_Cathedral_Structural_Proof_Network.png)
**Harmonic resonance network / Harmonisches Resonanznetzwerk**
Interconnected light field mapping the energy flow through the cathedral’s spatial harmonics.

![Prime Bridge 97 ↔ 103](./visuals/VII_PrimeBridge_97_103.png)
**Harmonic axis inside the core / Harmonische Achse im Kern**
Bridge between prime frequencies within the cathedral core; a geometric conductor of resonance symmetry.
