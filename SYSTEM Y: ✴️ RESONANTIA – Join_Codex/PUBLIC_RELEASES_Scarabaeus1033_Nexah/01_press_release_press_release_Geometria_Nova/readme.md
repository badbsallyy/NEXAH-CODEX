...
| Visual                                                                                  | Description                                                                                                                                        |
| :-------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Screenshot 1](./visuals/Screenshot_cathedral_v7_TH_rotated_plus_cosmic_web.png)       | **Cathedral v7 — Rotated + Cosmic Web View I**<br>Vertical harmonic projection – link between photon grid, Möbius field and golden navigator.      |
| ![Screenshot 2](./visuals/Screenshot_cathedral_v7_TH_rotated_plus_cosmic_webvii.png)    | **Cathedral v7 — Rotated + Cosmic Web View II**<br>Field depth with prime arches and halo resonance – dynamic animation ready (GLB rotation loop). |
| ![Screenshot 3](./visuals/Screenshot_resonance_cathedral_with_golden_polyhedron_v1.png) | **Cathedral v1 + Golden Polyhedron**<br>Core structure showing light-vault geometry and field breathing pattern.                                   |
