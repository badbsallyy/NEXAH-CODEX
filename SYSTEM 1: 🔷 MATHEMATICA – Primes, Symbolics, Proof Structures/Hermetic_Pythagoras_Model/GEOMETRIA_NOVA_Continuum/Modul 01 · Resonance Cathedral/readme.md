...
The **Resonance Cathedral** is the foundational architecture of the *GEOMETRIA NOVA Continuum*.
It unites *mathematical resonance*, *prime geometry* and *harmonic field syntax* into a coherent spatial grammar.
Each layer represents one octave of geometric density — from **prime sequence fields** to **mirror gates** and **cathedral breathing loops**.
...
| :-------------------------------------------------- | :------------- | :------------------------------------------------ |
| `cathedral_v8_8_fusion.glb`                         | 3D Model (GLB) | Base fusion architecture of Resonance Cathedral.  |
| `cathedral_v8_9_primegrid_viewer.html`              | HTML           | Interactive PrimeGrid viewer.                     |
| `Kathedrale 8.9+ – Modul-Layer-Schema.png`          | Diagram        | Cross-section of harmonic layer architecture.     |
| `resonance_cathedral_with_golden_polyhedron_v1.glb` | 3D Model       | Polyhedral integration of golden resonance field. |
| `EXTENSION-golden Polygon_Resonance Cathedral.pdf`  | PDF            | Supplemental analysis of polygonal harmonics.     |

> All models are stored in `/glb/` and visual assets in `/visuals/`.
...
*The field reaches equilibrium when prime frequency and mirror axis cancel each other in harmonic superposition.*
...
├── README.md
├── visuals/
│   ├─ Kathedrale_8.9+_Modul-Layer-Schema.png
│   └─ Resonance_Cathedral_PrimeGrid_View.png
├── glb/
│   ├─ cathedral_v8_8_fusion.glb
│   ├─ cathedral_v8_9_primegrid_viewer.html
