...
| Visual | Description |
| :------ | :----------- |
| ![Resonance Cathedral Core](./visuals/Resonance_Cathedral_Core.png) | The central fusion field of the Cathedral — structural resonance hub. |
| ![Cathedral Field Grid](./visuals/Cathedral_Field_Grid.png) | Grid projection of prime-frequency alignment (2–97). |
| ![Golden Polyhedron Integration](./visuals/Screenshot_resonance_cathedral_with_golden_polyhedron_v1.png) | Integration of golden symmetry field into quaternionic space. |
| ![Data Flow Diagram (SVG)](./visuals/Resonance_Cathedral_DataFlow.svg) | Full resonance and data stream map of the Cathedral system. |
| ![Prime Web Ulam](./visuals/Screenshot_Prime_Web_Ulam3D.png) | Ulam prime lattice forming the base resonant topology. |

> All models are stored in `/glb/`, visuals in `/visuals/`, and JSON/CSV data in `/Json_Csv/`.
