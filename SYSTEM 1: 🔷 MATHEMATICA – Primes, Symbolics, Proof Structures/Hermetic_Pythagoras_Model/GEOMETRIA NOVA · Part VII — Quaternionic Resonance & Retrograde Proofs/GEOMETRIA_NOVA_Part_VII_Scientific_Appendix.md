...
| :-------------------------------------------------------------------------------------------------- | :----------------------- | :--------------------------------------------------------------------------- |
| ![VII\_PrimeBridge\_97\_103.png](./visuals_Data/VII_PrimeBridge_97_103.png)                         | **Prime Bridge 97–103**  | Structural link between resonators — geometric base of Prime Axis 1231.      |
| ![VII\_FieldProjection.png](./visuals_Data/VII_FieldProjection.png)                                 | **Field Projection**     | ψ-Field envelope around Prime 1231 — breathing halo and density field.       |
| ![VII\_HarmonicCore\_v1.png](./visuals_Data/VII_HarmonicCore_v1.png)                                | **Harmonic Core v1**     | Resonant core bridge between 97 ↔ 103 within PrimeGrid (11² nodes).          |
| ![RedBlue\_Obelisk.png](./visuals_Data/RedBlue_Obelisk.png)                                         | **Red–Blue Obelisk**     | Solar–Lunar poles of the Cathedral; vertical duality of resonance.           |
| ![Astrolabium.png](./visuals_Data/Astrolabium.png)                                                  | **Astrolabium**          | Retrograde measurement instrument mapping temporal loops.                    |
| ![Golden\_Spiral\_Mosaic.png](./visuals_Data/Golden_Spiral_Mosaic.png)                              | **Golden Spiral Mosaic** | Fibonacci and φ:π ratio projection in floor geometry.                        |
| ![CathedralFloor.png](./visuals_Data/CathedralFloor.png)                                            | **Cathedral Floor**      | 10 × 10 factorial grid – resonant blueprint of the Codex Cathedral.          |
| ![Screenshot\_PartVII\_HarmonicCore\_v1.png](./visuals_Data/Screenshot_PartVII_HarmonicCore_v1.png) | **3D Reference View**    | Render snapshot of the HarmonicCore glTF; prime axis interaction visualized. |
...
![Screenshot — GEOMETRIA NOVA Part VII](./visuals_Data/Screenshot_GEOMETRIA_NOVA_PartVII.png)
